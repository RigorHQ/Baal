...
contract Shares is BaalVotes, ERC20SnapshotUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    uint256 public constant lockTimestamp;
        ...
        initializer
    {
        ...
        lockTimestamp = block.timestamp + 10 minutes;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            from == address(0) || /*Minting allowed*/
                ...
                !paused() || /*Transfers allowed when not paused*/
                block.timestamp > lockTimestamp, /*Transfers allowed after lockTimestamp*/
            "shares: !transferable"
        );
    }
